...
std::unique_ptr<dom::Element> DerivedTypeSymbol::CreateElement()
{
    std::unique_ptr<dom::Element> typeElement(new dom::Element(U"derivedType"));
    std::unique_ptr<dom::Element> derivationsElement(new dom::Element(U"derivations"));
    for (Derivation derivation : derivations)
    {
        std::unique_ptr<dom::Element> derivationElement(new dom::Element(U"derivation"));
        switch (derivation)
        {
        ...
        derivationsElement->AppendChild(std::unique_ptr<dom::Node>(derivationElement.release()));
    }
    typeElement->AppendChild(std::unique_ptr<dom::Node>(derivationsElement.release()));
    return typeElement;
}
