...
Keyword::Keyword(gendoc::parsing::ParsingDomain* parsingDomain_): gendoc::parsing::Grammar(ToUtf32("Keyword"), parsingDomain_->GetNamespaceScope(ToUtf32("gendoc.cppparser")), parsingDomain_)
{
    SetOwner(0);
    ...
    keywords0.push_back(ToUtf32("char16_t"));
    keywords0.push_back(ToUtf32("char32_t"));
