...
#ifndef GENDOC_XML_XML_PROCESSOR
#define GENDOC_XML_XML_PROCESSOR
...
public:
    ...
    void EndStartTag(const gendoc::parsing::Span& span, const std::string& systemId);
    void EndTag(const std::u32string& tagName, const gendoc::parsing::Span& span, const std::string& systemId);
    void AddAttribute(const std::u32string& attName, const std::u32string& attValue, const gendoc::parsing::Span& span, const std::string& systemId);
    void EntityRef(const std::u32string& entityName, const gendoc::parsing::Span& span, const std::string& systemId);
...
private:
    ...
    std::string GetErrorLocationStr(const std::string& systemId, const gendoc::parsing::Span& span) const;
    void ParseQualifiedName(const std::u32string& qualifiedName, std::u32string& localName, std::u32string& prefix, const gendoc::parsing::Span& span, const std::string& systemId);
    std::u32string GetNamespaceUri(const std::u32string& namespacePrefix, const gendoc::parsing::Span& span, const std::string& systemId);
};

} } // namespace gendoc::xml

#endif // GENDOC_XML_XML_PROCESSOR
