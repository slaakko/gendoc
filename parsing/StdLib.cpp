...
stdlib* stdlib::Create(gendoc::parsing::ParsingDomain* parsingDomain)
{
...
stdlib::stdlib(gendoc::parsing::ParsingDomain* parsingDomain_): gendoc::parsing::Grammar(ToUtf32("stdlib"), parsingDomain_->GetNamespaceScope(ToUtf32("gendoc.parsing")), parsingDomain_)
{
    SetOwner(0);
}

class stdlib::intRule : public gendoc::parsing::Rule
{
public:
    ...
    void Leave(gendoc::parsing::ObjectStack& stack, gendoc::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<gendoc::parsing::Object>(new gendoc::parsing::ValueObject<int32_t>(context->value)));
        }
    ...
    void Link() override
    {
        ...
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<intRule>(this, &intRule::A0Action));
    }
...
class stdlib::uintRule : public gendoc::parsing::Rule
{
public:
    ...
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<uintRule>(this, &uintRule::A0Action));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::longRule : public gendoc::parsing::Rule
{
public:
    ...
    void Leave(gendoc::parsing::ObjectStack& stack, gendoc::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<gendoc::parsing::Object>(new gendoc::parsing::ValueObject<int64_t>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<longRule>(this, &longRule::A0Action));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::ulongRule : public gendoc::parsing::Rule
{
public:
    ...
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<ulongRule>(this, &ulongRule::A0Action));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::hexuintRule : public gendoc::parsing::Rule
{
public:
    ...
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<hexuintRule>(this, &hexuintRule::A0Action));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::hexRule : public gendoc::parsing::Rule
{
public:
    ...
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<hexRule>(this, &hexRule::A0Action));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::hex_literalRule : public gendoc::parsing::Rule
{
public:
    ...
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<hex_literalRule>(this, &hex_literalRule::A0Action));
        gendoc::parsing::NonterminalParser* hexNonterminalParser = GetNonterminal(ToUtf32("hex"));
        hexNonterminalParser->SetPostCall(new gendoc::parsing::MemberPostCall<hex_literalRule>(this, &hex_literalRule::Posthex));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
    ...
    void Posthex(gendoc::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        if (matched)
        {
            std::unique_ptr<gendoc::parsing::Object> fromhex_value = std::move(stack.top());
            context->fromhex = *static_cast<gendoc::parsing::ValueObject<uint64_t>*>(fromhex_value.get());
            stack.pop();
        }
    }
private:
...
class stdlib::realRule : public gendoc::parsing::Rule
{
public:
    ...
    void Leave(gendoc::parsing::ObjectStack& stack, gendoc::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<gendoc::parsing::Object>(new gendoc::parsing::ValueObject<double>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<realRule>(this, &realRule::A0Action));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::urealRule : public gendoc::parsing::Rule
{
public:
    ...
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<urealRule>(this, &urealRule::A0Action));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::numRule : public gendoc::parsing::Rule
{
public:
    ...
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<numRule>(this, &numRule::A0Action));
        gendoc::parsing::ActionParser* a1ActionParser = GetAction(ToUtf32("A1"));
        a1ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<numRule>(this, &numRule::A1Action));
        gendoc::parsing::NonterminalParser* rNonterminalParser = GetNonterminal(ToUtf32("r"));
        rNonterminalParser->SetPostCall(new gendoc::parsing::MemberPostCall<numRule>(this, &numRule::Postr));
        gendoc::parsing::NonterminalParser* iNonterminalParser = GetNonterminal(ToUtf32("i"));
        iNonterminalParser->SetPostCall(new gendoc::parsing::MemberPostCall<numRule>(this, &numRule::Posti));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
    ...
    void Postr(gendoc::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        if (matched)
        {
            std::unique_ptr<gendoc::parsing::Object> fromr_value = std::move(stack.top());
            context->fromr = *static_cast<gendoc::parsing::ValueObject<double>*>(fromr_value.get());
            stack.pop();
        }
    }
    void Posti(gendoc::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        if (matched)
        {
            std::unique_ptr<gendoc::parsing::Object> fromi_value = std::move(stack.top());
            context->fromi = *static_cast<gendoc::parsing::ValueObject<int32_t>*>(fromi_value.get());
            stack.pop();
        }
    }
private:
...
class stdlib::boolRule : public gendoc::parsing::Rule
{
public:
    ...
    void Leave(gendoc::parsing::ObjectStack& stack, gendoc::parsing::ParsingData* parsingData, bool matched) override
    {
        ...
        if (matched)
        {
            stack.push(std::unique_ptr<gendoc::parsing::Object>(new gendoc::parsing::ValueObject<bool>(context->value)));
        }
        parsingData->PopContext(Id());
    }
    void Link() override
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<boolRule>(this, &boolRule::A0Action));
        gendoc::parsing::ActionParser* a1ActionParser = GetAction(ToUtf32("A1"));
        a1ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<boolRule>(this, &boolRule::A1Action));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::identifierRule : public gendoc::parsing::Rule
{
public:
...
class stdlib::qualified_idRule : public gendoc::parsing::Rule
{
public:
    ...
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<qualified_idRule>(this, &qualified_idRule::A0Action));
        gendoc::parsing::NonterminalParser* firstNonterminalParser = GetNonterminal(ToUtf32("first"));
        firstNonterminalParser->SetPostCall(new gendoc::parsing::MemberPostCall<qualified_idRule>(this, &qualified_idRule::Postfirst));
        gendoc::parsing::NonterminalParser* restNonterminalParser = GetNonterminal(ToUtf32("rest"));
        restNonterminalParser->SetPostCall(new gendoc::parsing::MemberPostCall<qualified_idRule>(this, &qualified_idRule::Postrest));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::escapeRule : public gendoc::parsing::Rule
{
public:
    ...
    {
        gendoc::parsing::ActionParser* a0ActionParser = GetAction(ToUtf32("A0"));
        a0ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<escapeRule>(this, &escapeRule::A0Action));
        gendoc::parsing::ActionParser* a1ActionParser = GetAction(ToUtf32("A1"));
        a1ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<escapeRule>(this, &escapeRule::A1Action));
        gendoc::parsing::ActionParser* a2ActionParser = GetAction(ToUtf32("A2"));
        a2ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<escapeRule>(this, &escapeRule::A2Action));
        gendoc::parsing::NonterminalParser* xNonterminalParser = GetNonterminal(ToUtf32("x"));
        xNonterminalParser->SetPostCall(new gendoc::parsing::MemberPostCall<escapeRule>(this, &escapeRule::Postx));
        gendoc::parsing::NonterminalParser* decimalEscapeNonterminalParser = GetNonterminal(ToUtf32("decimalEscape"));
        decimalEscapeNonterminalParser->SetPostCall(new gendoc::parsing::MemberPostCall<escapeRule>(this, &escapeRule::PostdecimalEscape));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
    ...
    void Postx(gendoc::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        ...
        if (matched)
        {
            ...
            context->fromx = *static_cast<gendoc::parsing::ValueObject<uint64_t>*>(fromx_value.get());
            stack.pop();
        }
    }
    void PostdecimalEscape(gendoc::parsing::ObjectStack& stack, ParsingData* parsingData, bool matched)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
        if (matched)
        {
            std::unique_ptr<gendoc::parsing::Object> fromdecimalEscape_value = std::move(stack.top());
            context->fromdecimalEscape = *static_cast<gendoc::parsing::ValueObject<uint32_t>*>(fromdecimalEscape_value.get());
            stack.pop();
        }
    }
private:
...
class stdlib::charRule : public gendoc::parsing::Rule
{
public:
    ...
    void Link() override
    {
        ...
        gendoc::parsing::ActionParser* a1ActionParser = GetAction(ToUtf32("A1"));
        a1ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<charRule>(this, &charRule::A1Action));
        gendoc::parsing::NonterminalParser* escapeNonterminalParser = GetNonterminal(ToUtf32("escape"));
        escapeNonterminalParser->SetPostCall(new gendoc::parsing::MemberPostCall<charRule>(this, &charRule::Postescape));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
class stdlib::stringRule : public gendoc::parsing::Rule
{
public:
    ...
    void Link() override
    {
        ...
        gendoc::parsing::ActionParser* a1ActionParser = GetAction(ToUtf32("A1"));
        a1ActionParser->SetAction(new gendoc::parsing::MemberParsingAction<stringRule>(this, &stringRule::A1Action));
        gendoc::parsing::NonterminalParser* escapeNonterminalParser = GetNonterminal(ToUtf32("escape"));
        escapeNonterminalParser->SetPostCall(new gendoc::parsing::MemberPostCall<stringRule>(this, &stringRule::Postescape));
    }
    void A0Action(const char32_t* matchBegin, const char32_t* matchEnd, const Span& span, const std::string& fileName, ParsingData* parsingData, bool& pass)
    {
        Context* context = static_cast<Context*>(parsingData->GetContext(Id()));
...
{
    AddRule(new gendoc::parsing::Rule(ToUtf32("spaces"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new gendoc::parsing::PositiveParser(
            new gendoc::parsing::SpaceParser())));
    AddRule(new gendoc::parsing::Rule(ToUtf32("newline"), GetScope(), GetParsingDomain()->GetNextRuleId(),
    ...
    AddRule(new gendoc::parsing::Rule(ToUtf32("comment"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new gendoc::parsing::AlternativeParser(
            new gendoc::parsing::NonterminalParser(ToUtf32("line_comment"), ToUtf32("line_comment"), 0),
            new gendoc::parsing::NonterminalParser(ToUtf32("block_comment"), ToUtf32("block_comment"), 0))));
    AddRule(new gendoc::parsing::Rule(ToUtf32("line_comment"), GetScope(), GetParsingDomain()->GetNextRuleId(),
    ...
    AddRule(new gendoc::parsing::Rule(ToUtf32("block_comment"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new gendoc::parsing::SequenceParser(
            new gendoc::parsing::SequenceParser(
                new gendoc::parsing::StringParser(ToUtf32("/*")),
                new gendoc::parsing::KleeneStarParser(
                        ...
                        new gendoc::parsing::AlternativeParser(
                            ...
                            new gendoc::parsing::GroupingParser(
                                new gendoc::parsing::DifferenceParser(
                                    ...
                                    new gendoc::parsing::StringParser(ToUtf32("*/")))))))),
            new gendoc::parsing::StringParser(ToUtf32("*/")))));
    AddRule(new gendoc::parsing::Rule(ToUtf32("spaces_and_comments"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new gendoc::parsing::PositiveParser(
            new gendoc::parsing::GroupingParser(
                new gendoc::parsing::AlternativeParser(
                    new gendoc::parsing::SpaceParser(),
                    new gendoc::parsing::NonterminalParser(ToUtf32("comment"), ToUtf32("comment"), 0))))));
    AddRule(new gendoc::parsing::Rule(ToUtf32("digit_sequence"), GetScope(), GetParsingDomain()->GetNextRuleId(),
            ...
            new gendoc::parsing::TokenParser(
                new gendoc::parsing::SequenceParser(
                    ...
                    new gendoc::parsing::ExpectationParser(
                        new gendoc::parsing::NonterminalParser(ToUtf32("hex"), ToUtf32("hex"), 0)))))));
        ...
        new gendoc::parsing::ActionParser(ToUtf32("A0"),
            new gendoc::parsing::TokenParser(
                new gendoc::parsing::SequenceParser(
                    ...
                    new gendoc::parsing::GroupingParser(
                        new gendoc::parsing::AlternativeParser(
                            new gendoc::parsing::NonterminalParser(ToUtf32("fractional_real"), ToUtf32("fractional_real"), 0),
                            new gendoc::parsing::NonterminalParser(ToUtf32("exponent_real"), ToUtf32("exponent_real"), 0))))))));
        ...
        new gendoc::parsing::ActionParser(ToUtf32("A0"),
            new gendoc::parsing::GroupingParser(
                new gendoc::parsing::AlternativeParser(
                    new gendoc::parsing::NonterminalParser(ToUtf32("fractional_real"), ToUtf32("fractional_real"), 0),
                    new gendoc::parsing::NonterminalParser(ToUtf32("exponent_real"), ToUtf32("exponent_real"), 0))))));
    AddRule(new gendoc::parsing::Rule(ToUtf32("fractional_real"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new gendoc::parsing::AlternativeParser(
            new gendoc::parsing::TokenParser(
                new gendoc::parsing::SequenceParser(
                    new gendoc::parsing::SequenceParser(
                        ...
                        new gendoc::parsing::NonterminalParser(ToUtf32("digit_sequence"), ToUtf32("digit_sequence"), 0)),
                    new gendoc::parsing::OptionalParser(
                        new gendoc::parsing::NonterminalParser(ToUtf32("exponent_part"), ToUtf32("exponent_part"), 0)))),
            new gendoc::parsing::TokenParser(
                new gendoc::parsing::SequenceParser(
                    new gendoc::parsing::NonterminalParser(ToUtf32("digit_sequence"), ToUtf32("digit_sequence"), 0),
                    new gendoc::parsing::CharParser('.'))))));
    AddRule(new gendoc::parsing::Rule(ToUtf32("exponent_real"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new gendoc::parsing::TokenParser(
            new gendoc::parsing::SequenceParser(
                new gendoc::parsing::NonterminalParser(ToUtf32("digit_sequence"), ToUtf32("digit_sequence"), 0),
                new gendoc::parsing::NonterminalParser(ToUtf32("exponent_part"), ToUtf32("exponent_part"), 0)))));
    AddRule(new gendoc::parsing::Rule(ToUtf32("exponent_part"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new gendoc::parsing::TokenParser(
            new gendoc::parsing::SequenceParser(
                new gendoc::parsing::SequenceParser(
    ...
    AddRule(new numRule(ToUtf32("num"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new gendoc::parsing::AlternativeParser(
            new gendoc::parsing::ActionParser(ToUtf32("A0"),
                new gendoc::parsing::NonterminalParser(ToUtf32("r"), ToUtf32("real"), 0)),
            new gendoc::parsing::ActionParser(ToUtf32("A1"),
                new gendoc::parsing::NonterminalParser(ToUtf32("i"), ToUtf32("int"), 0)))));
    ...
    AddRule(new identifierRule(ToUtf32("identifier"), GetScope(), GetParsingDomain()->GetNextRuleId(),
        new gendoc::parsing::ActionParser(ToUtf32("A0"),
            new gendoc::parsing::TokenParser(
                new gendoc::parsing::SequenceParser(
                    new gendoc::parsing::IdStartParser(),
                    new gendoc::parsing::KleeneStarParser(
                        new gendoc::parsing::IdContParser()))))));
            ...
            new gendoc::parsing::SequenceParser(
                ...
                new gendoc::parsing::GroupingParser(
                    new gendoc::parsing::AlternativeParser(
                        new gendoc::parsing::AlternativeParser(
                            new gendoc::parsing::SequenceParser(
                                new gendoc::parsing::CharSetParser(ToUtf32("xX")),
                                new gendoc::parsing::ActionParser(ToUtf32("A0"),
                                    new gendoc::parsing::NonterminalParser(ToUtf32("x"), ToUtf32("hex"), 0))),
                            new gendoc::parsing::SequenceParser(
                                new gendoc::parsing::CharSetParser(ToUtf32("dD")),
                                new gendoc::parsing::ActionParser(ToUtf32("A1"),
                                    new gendoc::parsing::NonterminalParser(ToUtf32("decimalEscape"), ToUtf32("uint"), 0)))),
                        new gendoc::parsing::ActionParser(ToUtf32("A2"),
                            new gendoc::parsing::CharSetParser(ToUtf32("dDxX"), true))))))));
