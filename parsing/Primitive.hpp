...
#ifndef GENDOC_PARSING_PRIMITIVE_INCLUDED
#define GENDOC_PARSING_PRIMITIVE_INCLUDED
...
public:
    ...
    Match Parse(Scanner& scanner, ObjectStack& stack, ParsingData* parsingData) override;
    void Accept(Visitor& visitor) override;
    bool IsEmptyParser() const override { return true; }
};
...
#endif // GENDOC_PARSING_PRIMITIVE_INCLUDED
