...
std::unique_ptr<XPathObject> CompareNodeSets(XPathContext& context, XPathObject* left, XPathObject* right, Operator comparisonOp)
{
    if (left->Type() == XPathObjectType::nodeSet && right->Type() == XPathObjectType::nodeSet)
    {
        ...
        for (int i = 0; i < n; ++i)
        {
            gendoc::dom::Node* leftNode = (*leftNodeSet)[i];
            std::u32string leftStr = StringValue(leftNode);
            int m = rightNodeSet->Length();
            for (int j = 0; j < m; ++j)
            {
                gendoc::dom::Node* rightNode = (*rightNodeSet)[j];
    ...
    else if (right->Type() == XPathObjectType::nodeSet)
    {
        ...
        if (left->Type() == XPathObjectType::number)
        {
            ...
            for (int i = 0; i < n; ++i)
            {
                gendoc::dom::Node* rightNode = (*rightNodeSet)[i];
...
std::unique_ptr<XPathObject> XPathCombineStepExpr::Evaluate(XPathContext& context)
{
    ...
    for (int i = 0; i < n; ++i)
    {
        gendoc::dom::Node* node = (*leftNodeSet)[i];
        ...
        for (int i = 0; i < m; ++i)
        { 
            gendoc::dom::Node* node = (*rightNodeSet)[i];
            result->Add(node);
        }
    }
    return std::unique_ptr<XPathObject>(result.release());
...
std::unique_ptr<XPathObject> XPathRootNodeExpr::Evaluate(XPathContext& context)
{
    ...
    if (context.Node()->GetNodeType() == gendoc::dom::NodeType::documentNode)
    {
...
std::unique_ptr<XPathObject> XPathFilterExpr::Evaluate(XPathContext& context)
{
    ...
    for (int i = 0; i < n; ++i)
    {
        gendoc::dom::Node* node = (*nodeSet)[i];
...
class NodeSelectionOp : public gendoc::dom::NodeOp
{
public:
    NodeSelectionOp(XPathNodeTestExpr* nodeTest_, XPathNodeSet& nodeSet_, Axis axis_);
    void Apply(gendoc::dom::Node* node) override;
private:
...
void NodeSelectionOp::Apply(gendoc::dom::Node* node)
{
...
bool XPathPILiteralTest::Select(gendoc::dom::Node* node, Axis axis) const
{
    if (node->GetNodeType() == gendoc::dom::NodeType::processingInstructionNode)
    {
...
bool XPathCommentNodeTest::Select(gendoc::dom::Node* node, Axis axis) const
{
    return node->GetNodeType() == gendoc::dom::NodeType::commentNode;
}
...
bool XPathTextNodeTest::Select(gendoc::dom::Node* node, Axis axis) const
{
    return node->GetNodeType() == gendoc::dom::NodeType::textNode;
}
...
bool XPathPINodeTest::Select(gendoc::dom::Node* node, Axis axis) const
{
    return node->GetNodeType() == gendoc::dom::NodeType::processingInstructionNode;
}
...
bool XPathPrincipalNodeTest::Select(gendoc::dom::Node* node, Axis axis) const
{
    if (axis == Axis::attribute)
    {
        return node->GetNodeType() == gendoc::dom::NodeType::attributeNode;
    }
    ...
    {
        return node->GetNodeType() == gendoc::dom::NodeType::elementNode;
    }
}
...
bool XPathAnyNodeTest::Select(gendoc::dom::Node* node, Axis axis) const
{
    return true;
}
...
bool XPathPrefixTest::Select(gendoc::dom::Node* node, Axis axis) const
{
    if (axis == Axis::attribute)
    {
        if (node->GetNodeType() == gendoc::dom::NodeType::attributeNode)
        {
    ...
    else if (node->GetNodeType() == gendoc::dom::NodeType::elementNode)
    {
        gendoc::dom::Element* element = static_cast<gendoc::dom::Element*>(node); 
...
bool XPathNameTest::Select(gendoc::dom::Node* node, Axis axis) const
{
    if (axis == Axis::attribute)
    {
        if (node->GetNodeType() == gendoc::dom::NodeType::attributeNode)
    ...
    {
        if (node->GetNodeType() == gendoc::dom::NodeType::elementNode)
        {
            gendoc::dom::Element* element = static_cast<gendoc::dom::Element*>(node);
