...
#ifndef GENDOC_XPATH_XPATH_EXPR
#define GENDOC_XPATH_XPATH_EXPR
...
{
public:
    virtual bool Select(gendoc::dom::Node* node, Axis axis) const { return true; }
};
...
public:
    ...
    bool Select(gendoc::dom::Node* node, Axis axis) const override;
    std::unique_ptr<dom::Node> ToDom() const override;
private:
